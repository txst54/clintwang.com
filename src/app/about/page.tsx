  ...
  return (
    <div className="min-h-screen w-full px-4 py-8 flex items-center justify-center">
      <div className="flex flex-col items-center max-w-4xl w-full">
        <h1 className="text-3xl md:text-6xl font-serif text-center">About this site</h1>
        <p className="md:text-lg mt-4 mb-8 md:mb-12 text-center max-w-2xl">
        ...
        <div className="w-full px-2 md:px-0">
          <h2 className="text-2xl md:text-4xl font-serif">Architecture</h2>
          <p className="md:text-lg mt-4 text-left">
            ...
            {/*compiled directly to the GPU. */}
            The animation featured on the home page is a pre-rendered interpolation of decoded latent spaces for an
            autoencoder that encodes images of handwritten digits and decodes latent space as bezier curves.
            The site is built using Next.js and styled using TailwindCSS.
